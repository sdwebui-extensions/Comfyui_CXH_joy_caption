...
class Joy_caption_alpha_load:
    ...
    def loadCheckPoint(self):
        ...
        if not os.path.exists(adapter_path) and os.path.exists('/stable-diffusion-cache/models/Joy_caption_alpha'):
            adapter_path = '/stable-diffusion-cache/models/Joy_caption_alpha/image_adapter.pt'

        clip_model_path = os.path.join(folder_paths.models_dir,"Joy_caption_alpha","clip_model.pt")
        if not os.path.exists(clip_model_path) and os.path.exists('/stable-diffusion-cache/models/Joy_caption_alpha'):
            clip_model_path = '/stable-diffusion-cache/models/Joy_caption_alpha/clip_model.pt'

        CHECKPOINT_PATH = os.path.join(folder_paths.models_dir,"Joy_caption_alpha","text_model")
        if not os.path.exists(adapter_path) and os.path.exists('/stable-diffusion-cache/models/Joy_caption_alpha'):
            os.makedirs(CHECKPOINT_PATH, exist_ok=True)
            os.system(f'cp /stable-diffusion-cache/models/Joy_caption_alpha/text_model/* {os.path.join(folder_paths.models_dir,"Joy_caption_alpha","text_model")}/')
